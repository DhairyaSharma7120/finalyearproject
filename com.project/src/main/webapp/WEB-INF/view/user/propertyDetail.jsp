                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="<%=request.getContextPath()%>/userResources/image/properties-1.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="<%=request.getContextPath()%>/userResources/image/properties-2.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="<%=request.getContextPath()%>/userResources/image/properties-3.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="<%=request.getContextPath()%>/userResources/image/properties-4.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="<%=request.getContextPath()%>/userResources/image/properties-5.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                        </div>
                        ...
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                    <img src="<%=request.getContextPath()%>/userResources/image/properties-1.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                    <img src="<%=request.getContextPath()%>/userResources/image/properties-2.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                    <img src="<%=request.getContextPath()%>/userResources/image/properties-3.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                    <img src="<%=request.getContextPath()%>/userResources/image/properties-4.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-4" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                    <img src="<%=request.getContextPath()%>/userResources/image/properties-5.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                        </ul>
                        <!-- main slider carousel items -->
                        ...
                        <div class="tab-content" id="carTabContent">
                            ...
                            <div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <div class="floor-plans mb-50">
                                    ...
                                    <img src="<%=request.getContextPath()%>/userResources/image/floor-plans.png" alt="floor-plans" class="img-fluid">
                                </div>
                            </div>
                    ...
                    <ul class="comments">
                        <li>
                            <div class="comment">
                                <div class="comment-author">
                                    <a href="#">
                                        <img src="<%=request.getContextPath()%>/userResources/image/avatar-1.jpg" alt="comments-user">
                                    </a>
                                </div>
                            ...
                            <ul>
                                <li>
                                    <div class="comment">
                                        <div class="comment-author">
                                            <a href="#">
                                                <img src="<%=request.getContextPath()%>/userResources/image/avatar-2.jpg" alt="comments-user">
                                            </a>
                                        </div>
                                        <div class="comment-content">
                                            <div class="comment-meta">
                        ...
                        <li>
                            <div class="comment">
                                <div class="comment-author">
                                    <a href="#">
                                        <img src="<%=request.getContextPath()%>/userResources/image/avatar-3.jpg" alt="comments-user">
                                    </a>
                                </div>
                                <div class="comment-content">
                                    <div class="comment-meta">
                            ...
                            <ul>
                                <li>
                                    <div class="comment mb-0 mp-heden">
                                        <div class="comment-author">
                                            <a href="#">
                                                <img src="<%=request.getContextPath()%>/userResources/image/avatar-4.jpg" alt="comments-user">
                                            </a>
                                        </div>
