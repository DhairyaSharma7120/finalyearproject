...
<div class="contact-section">
    <div class="container">
        <div class="row login-box">
                ...
                <div class="form-section clearfix">
                    ...
                    <h:form action="saveRegister" method="post" modelAttribute="registerVO" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-box">
                            <h:input type="email" name="email" class="input-text" placeholder="Email Address" path="loginVO.username"/>
                        </div>
                        <div class="form-group form-box">
                        ...
                        <div class="form-group form-box">
                        			<input type="file" class="input-text" placeholder="Aadhaar Card" name="file" multiple="multiple"/>
                    	</div>
            ...
            <div class="col-lg-5 bg-color-15 align-self-center pad-0 none-992 bg-img">
                   
                   
                            <img src="<%=request.getContextPath()%>/userResources/image/img-1.jpg" class="bg-img" alt="black-logo">
