 ...
 * Generated at: 2021-02-23 08:40:58 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\tclass=\"nav-link\"><i data-feather=\"user\"></i><span>Manage User</span></a>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t<li class=\"dropdown\"><a href=\"#\"\r\n");
      out.write("\t\t\t\tclass=\"menu-toggle nav-link has-dropdown\"><i\r\n");
      out.write("\t\t\t\t\tdata-feather=\"layers\"></i><span>Manage Categories</span></a>\r\n");
      ...
      out.write("\t\t\t<li class=\"dropdown\"><a href=\"#\"\r\n");
      out.write("\t\t\t\tclass=\"menu-toggle nav-link has-dropdown\"><i\r\n");
      out.write("\t\t\t\t\tdata-feather=\"layers\"></i><span>Manage Subcategories</span></a>\r\n");
      out.write("\t\t\t\t<ul class=\"dropdown-menu\">\r\n");
      ...
      out.write("\t\t\t<li class=\"dropdown\"><a href=\"#\"\r\n");
      out.write("\t\t\t\tclass=\"menu-toggle nav-link has-dropdown\"><i\r\n");
      out.write("\t\t\t\t\tdata-feather=\"layers\"></i><span>Manage Construction Status </span></a>\r\n");
      out.write("\t\t\t\t<ul class=\"dropdown-menu\">\r\n");
      ...
      out.write("\t\t\t<li class=\"dropdown\"><a href=\"#\"\r\n");
      out.write("\t\t\t\tclass=\"menu-toggle nav-link has-dropdown\"><i\r\n");
      out.write("\t\t\t\t\tdata-feather=\"map\"></i><span>Manage State </span></a>\r\n");
      out.write("\t\t\t\t<ul class=\"dropdown-menu\">\r\n");
      ...
      out.write("\t\t\t\t<li class=\"dropdown\"><a href=\"#\"\r\n");
      out.write("\t\t\t\tclass=\"menu-toggle nav-link has-dropdown\"><i\r\n");
      out.write("\t\t\t\t\tdata-feather=\"map-pin\"></i><span>Manage City </span></a>\r\n");
      out.write("\t\t\t\t<ul class=\"dropdown-menu\">\r\n");
      ...
      out.write("\t\t\t\t<li class=\"dropdown\"><a href=\"#\"\r\n");
      out.write("\t\t\t\tclass=\"menu-toggle nav-link has-dropdown\"><i\r\n");
      out.write("\t\t\t\t\tdata-feather=\"map-pin\"></i><span>Manage Area </span></a>\r\n");
      out.write("\t\t\t\t<ul class=\"dropdown-menu\">\r\n");
      ...
      out.write("\t\t\t</li>  \t\t\t\r\n");
      out.write("\t\t\t<li class=\"dropdown\"><a href=\"./index.jsp\"\r\n");
      out.write("\t\t\t\tclass=\"nav-link\"><i data-feather=\"log-out\"></i><span>Logout</span></a>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\r\n");
      out.write("\t</aside>\r\n");
