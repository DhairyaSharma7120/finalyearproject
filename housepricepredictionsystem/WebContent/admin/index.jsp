			...
			<div class="background"></div>
				<div class="header-content">
					<div class="content">
						...
						<span>CHECK HOUSE LOAN</span><br> 
						<button class="get-started-btn" onclick="window.location='./register.jsp'">GET STARTED</button>
						</div>
								...
								<div class="card-body">
									...
									<div class="support-ticket media pb-1 mb-3">
										...
										<div class="media-body ml-3">
											...
											<p class="my-1">please check select item in advance form
												not work...</p>
											<small class="text-muted">Created by <span
									...
									<div class="support-ticket media pb-1 mb-3">
										...
										<div class="media-body ml-3">
											...
											<span class="font-weight-bold">#85784</span> <a
												...
												Angular?</a>
											<p class="my-1">can you provide template in latest
												angular 8.</p>
											<small class="text-muted">Created by <span
