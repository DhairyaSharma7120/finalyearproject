	...
	<ul class="navbar-nav navbar-right">
				...
				<div class="dropdown-list-content dropdown-list-message">
					<a href="#" class="dropdown-item"> <span
						class="dropdown-item-avatar
											text-white"> <img
							alt="image" src="adminResources/image/user-1.png"
						...
						class="dropdown-item-avatar text-white"> <img alt="image"
							src="adminResources/image/user-2.png" class="rounded-circle">
					</span> <span class="dropdown-item-desc"> <span
							class="message-user">Sarah Smith</span> <span
							class="time messege-text">Request for leave application</span> <span
							class="time">5 Min Ago</span>
					</span>
					</a> <a href="#" class="dropdown-item"> <span
						class="dropdown-item-avatar text-white"> <img alt="image"
							src="adminResources/image/user-5.png" class="rounded-circle">
					</span> <span class="dropdown-item-desc"> <span
						...
						class="dropdown-item-avatar text-white"> <img alt="image"
							src="adminResources/image/user-4.png" class="rounded-circle">
					</span> <span class="dropdown-item-desc"> <span
						...
						class="dropdown-item-avatar text-white"> <img alt="image"
							src="adminResources/image/user-3.png" class="rounded-circle">
					</span> <span class="dropdown-item-desc"> <span
							class="message-user">Jalpa Joshi</span> <span
							class="time messege-text">Please do as specify. Let me
								know if you have any query.</span> <span class="time">1 Days Ago</span>
					</span>
					</a> <a href="#" class="dropdown-item"> <span
						class="dropdown-item-avatar text-white"> <img alt="image"
							src="adminResources/image/user-2.png" class="rounded-circle">
				...
				<div class="dropdown-list-content dropdown-list-icons">
					<a href="#" class="dropdown-item dropdown-item-unread"> <span
						...
						class="dropdown-item-icon bg-success text-white"> <i
							class="fas
												fa-check"></i>
					</span> <span class="dropdown-item-desc"> <b>Kusnaedi</b> has moved
							task <b>Fix bug header</b> to <b>Done</b> <span class="time">12
								Hours Ago</span>
					</span>
					</a> <a href="#" class="dropdown-item"> <span
		...
		<li class="dropdown"><a href="#" data-toggle="dropdown"
			...
			<% String name = (String)session.getAttribute("xyz"); %>
				<div class="dropdown-title">Hello <% out.println(name); %></div>
